      ...
      messages: [
          { 
            ...
            content: "Ti si pomoćnik za poboljšavanje podataka o softverskom projektu. Pišeš na srpskom jeziku, koristeći ekavicu i vraćaš samo ono što se traži." +
                     ...
                     "Tvoj zadatak je da na osnovu dobijenog objekta napraviš objekat sa istim formatom koji ima 5 predložena kreativna naslova (naziva za aplikaciju) između 2 i 20 karaktera" + 
